 ...
 * @LastEditTime: 2023-03-06 17:45:44
...
4. After these steps, you can find and download our model weights file [here](https://github.com/NorthOcean/MSN/releases) and put them into the `./weights` folder (optional).
